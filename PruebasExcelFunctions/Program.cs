...
namespace PruebasExcelFunctions
{
    class ProyectoPruebaExcel
    {
        static void Main(string[] args)
        {
            ...
            string pathToExcel = @"C:\Users\oscarsanchez2\Desktop\210119_RB11P5MAYO.xlsx";
            ...
            //Console.WriteLine(myExcel.LanguageSettings.get_LanguageID(Microsoft.Office.Core.MsoAppLanguageID.msoLanguageIDUI));
            //Codigos de lenguaje:
            //1033: en-us
            //2058: es-mx

            Console.WriteLine(EraseExcelCells(pathToExcel));
        ...
        public static string vLookUpEmulator(string pathToExcelFile)
        {
            ...
            Microsoft.Office.Interop.Excel.Range range = (Microsoft.Office.Interop.Excel.Range)myExcel.get_Range(worksheet.Cells[1, 1], worksheet.Cells[99, 99]);

            string val = myExcel.WorksheetFunction.VLookup("Valor", range, 1,false);
